...
module.exports = [
  ...
  { method: 'GET', path: '/timeline/personal', config: Tweets.personaltimeline },
  { method: 'POST', path: '/sendtweet', config: Tweets.sendtweet },
  { method: 'GET', path: '/getpicture/{_id}', config: Tweets.getpicture },
  { method: 'GET', path: '/getavatar/{_id}', config: Users.getavatar },
  { method: 'GET', path: '/followuser/{id}', config: Users.followuser },
