...
public class Clock
{
    ...
    /**
     * Set days value of clock 
     * @param value New days value
     */
    public void resetDays(int value){
        clock.resetDays(value);
        label.setText(clock.getTime());
    }
    ...
    {
        frame = new JFrame("Clock (Days : Hours : Minutes : Second)");
        JPanel contentPane = (JPanel)frame.getContentPane();
        contentPane.setBorder(new EmptyBorder(1, 135, 1, 135));
